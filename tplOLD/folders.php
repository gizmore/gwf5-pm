<?php
$headers = array(
	array($lang->lang('th_pmf_name'), 'pmf_name', 'ASC'),
	array($lang->lang('th_pmf_count'), 'pmf_count', 'DESC'),
	array(),
);
...
echo GWF_Table::rowStart();
echo GWF_Table::column(GWF_Form::submit('delete_folder', $lang->lang('btn_delete')), 'ri', 3);
echo GWF_Table::rowEnd();
