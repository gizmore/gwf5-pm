...
$headers = array(
	array($lang->lang('th_pm_options&1'), 'pm_options&1'),
	array($lang->lang('th_pm_date'), 'pm_date'),
	array($lang->lang('th_pm_from')), #, 'T_A.user_name'),
	array($lang->lang('th_pm_to')), # 'T_B.user_name'),
	array($lang->lang('th_pm_title'), 'pm_title'),
